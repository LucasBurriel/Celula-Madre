...
\begin{itemize}
    ...
    \item \textbf{V6.5 (ongoing):} Tests market-based selection on AG News, isolating the effect of selection mechanism from task complexity. Preliminary results show healthy market dynamics with increasing Gini coefficients.
...
\textbf{Preliminary results (Market Run 1, gens 0--3):} Best validation accuracy reached 93\% at generation 1 (vs.\ V6 tournament peak of 96\% at gen 6). Market dynamics show healthy competition: Gini coefficient increased from 0.099 (gen 0) to 0.204 (gen 3), indicating emergent specialization. Mutations are passing gating: gen 1 saw agent 0 mutate to agent 11 (90\%$\rightarrow$94\%), and gen 2 produced agents 9 and 10 at 94\%. The market is selecting effectively---clients prefer higher-performing agents, creating revenue-based selection pressure.
